...
<header class="masthead">
	...
	<!-- 	<div class="board-search">
			<input type="search" placeholder="Search" class="board-search-input" aria-label="Board Search">
...
<section class="lists-container">
	<aside class="menubar">
    <!-- Profil og andre elementer her -->
    <div class="profile">
        <img src="../assets/donut_02.jpg" alt="Profile Picture">
        <span>//Bruger</span>
    </div>
    <div class="menu-links">
        <a href="#">To Do Board 💫</a>
        <a href=""></a>
    </div>
    <button class="boards-btn btn" style="font-size: 14px; font-weight: 100; padding: 5px;"> Add list</button>
